...
## Project Structure
    ...
    ├── testappgeneration_d_32327  # Django project configurations
...
1. Clone this repo and `cd testappgeneration_d_32327`
...
2. Clone this repo and `cd testappgeneration_d_32327`
